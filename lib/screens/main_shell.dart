...
class _MainShellState extends State<MainShell> {
  ...
  Future<void> _closeDrawerThenPush(BuildContext drawerContext, Widget page) async {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  scheme.primary,
                  Color.lerp(scheme.primary, const Color(0xFF0F1729), 0.35)!,
                ],
              ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (isLoggedIn) ...[
                  ...
                  Row(
                    children: [
                      Icon(Icons.person_rounded, size: 18, color: scheme.onPrimary.withValues(alpha: 0.9)),
          ...
          if (!isLoggedIn) ...[
            ListTile(
              ...
              onTap: () => _closeDrawerThenPush(drawerContext, const LoginPage()),
            ),
            ListTile(
              leading: const Icon(Icons.person_add),
              title: const Text('Kayıt Ol'),
              onTap: () => _closeDrawerThenPush(drawerContext, const RegisterPage()),
            ),
          ] else ...[
            ListTile(
